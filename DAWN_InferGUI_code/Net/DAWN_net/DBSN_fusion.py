...
class DBSN_fusion(nn.Module):
    def __init__(self, in_ch, out_ch, mid_ch, 
        ...
        #TODO
        self.branch_head_x1 = DC_branch_head(br1_dilation_base, in_ch,mid_ch,bs_conv_type=blindspot_conv_type,when_fusion='early')                                             
        self.branch_head_x2 = DC_branch_head(br2_dilation_base, in_ch,mid_ch,bs_conv_type=blindspot_conv_type,when_fusion='early')
        self.branch_head_y1 = DC_branch_head(br1_dilation_base, in_ch,mid_ch,bs_conv_type=blindspot_conv_type,when_fusion='early')
        self.branch_head_y2 = DC_branch_head(br2_dilation_base, in_ch,mid_ch,bs_conv_type=blindspot_conv_type,when_fusion='early')
