...
* **DAWN Source Code**
  Contains the full codebase for both GUI and DAWN training/testing. This component is fully customizable to support your own extensions or modifications.

Detailed instructions and important precautions for each part are provided in the corresponding `README.md` files.
