...
# Import PyQt6 for thread support (optional for standalone SystemMonitor usage)
try:
...
class SystemMetrics:
    ...
    def __init__(self):
        ...
        self.gpu_count = 0
        self.gpu_metrics = []  # List of dict for each GPU
...
class SystemMonitor:
    ...
    def get_gpu_metrics(self, device_id=0):
        """Get GPU usage metrics for specific device"""
    ...
    def get_all_metrics(self):
        """Get all system metrics (CPU + all GPUs)"""
...
if PYQT6_AVAILABLE:
    class MonitorThread(QThread):
        ...
        metricsUpdated = pyqtSignal(object)  # Emits SystemMetrics object
    ...
    # Dummy class if PyQt6 is not available
    class MonitorThread:
        """Dummy MonitorThread class when PyQt6 is not available"""
