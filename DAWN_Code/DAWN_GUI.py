...
class VideoReconstructionApp(QMainWindow):
    ...
    def create_widgets(self):
        ...
        self.input_browse1.clicked.connect(lambda: self.browse_input_path("a"))
        ...
        self.input_browse2.clicked.connect(lambda: self.browse_input_path("b"))
        ...
        self.single_input_browse.clicked.connect(lambda: self.browse_input_path("single"))
